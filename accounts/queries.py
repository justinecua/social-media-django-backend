...
def login(username, password):
    ...
    try:
        ...
        query = """
                SELECT firstname, lastname, gender, bio, age, birthday, profile_photo, cover_photo, cover_photo_id_imagekit, profile_photo_id_imagekit, username, password, date_joined, public.auth_user.id
...
def getNewUsers():
    try:
        query = f"""
                SELECT profile_photo, username, date_joined FROM public.accounts_account
                LEFT JOIN public.auth_user ON public.accounts_account.auth_user_id = public.auth_user.id
